# 🌟 Aponte: O Seu Match Perfeito com a Produtividade (e o Foco!)
...
- 🔗 **Backend**: [AponteBackEnd](https://github.com/RuanCabralBandeira/AponteBackEnd) - Consumo de **API REST/GraphQL** (lógica de matching + controle do timer 24h)
...
1. **Clone o repositório**
   ```bash
   git clone https://github.com/RuanCabralBandeira/AponteFrontEnd.git
   ```
